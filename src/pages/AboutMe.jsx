...
export default function AboutMe() {
  return (
    <main className="min-h-screen relative" id="About">
      <div className="container flex flex-col lg:flex-row items-center py-12 sm:py-16 md:py-20 px-4 sm:px-6 relative z-0">
        {/* Left Section */}
        <div className="flex-1 p-4 sm:p-6 md:p-8 flex flex-col justify-center relative order-2 lg:order-1">
          ...
          />
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 sm:mb-6 text-center lg:text-left animate-on-scroll fade-in-left animate-visible">
            About <span className="text-cyanThm">me</span>
          </h1>{" "}
          <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 text-center lg:text-left">
            {" "}
            <p className="text-whiteThm/90 leading-relaxed text-base sm:text-lg font-poppins animate-on-scroll fade-in-left animate-visible stagger-1">
              👋 Hi! I&apos;m{" "}
            ...
            <p className="text-whiteThm/80 leading-relaxed text-sm sm:text-base font-poppins animate-on-scroll fade-in-left animate-visible stagger-3 animate-on-scroll fade-in-left animate-visible stagger-2">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-4 mt-4 sm:mt-6 animate-on-scroll fade-in-up animate-visible stagger-4">
        ...
        <div className="flex-1 relative flex items-center justify-center p-4 sm:p-6 md:p-8 order-1 lg:order-2 mb-6 lg:mb-0 animate-on-scroll fade-in-right animate-visible">
          <img
            src={doodleItems}
            alt="Doodle elements"
          ...
          <div className="relative w-3/4 sm:w-4/5 max-w-[300px] sm:max-w-[400px] lg:max-w-none hover:scale-105 transition-transform duration-500">
