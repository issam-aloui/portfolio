    ...
    <section
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-cyanThm/10 via-greyThm/20 to-purple-500/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border-2 border-cyanThm/30 shadow-lg shadow-cyanThm/10 relative overflow-hidden">
            {/* Decorative elements */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <a
                ...
                className="flex flex-col items-center text-center p-6 bg-cyanThm/20 hover:bg-cyanThm/30 text-cyanThm rounded-lg transition-all duration-300 hover:scale-105 border border-cyanThm/40">
              ...
              <a
                ...
                className="flex flex-col items-center text-center p-6 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 rounded-lg transition-all duration-300 hover:scale-105 border border-blue-500/40">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center text-center p-6 bg-gray-500/20 hover:bg-gray-500/30 text-gray-400 rounded-lg transition-all duration-300 hover:scale-105 border border-gray-500/40">
              ...
              {/* Status */}
              <div className="flex flex-col items-center text-center p-6 bg-green-500/20 rounded-lg border border-green-500/40 relative overflow-hidden">
                {/* Decorative elements */}
